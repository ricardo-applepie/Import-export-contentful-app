...
function Home(){
    ...
    function checkedProperties(e: any) {
        ...
        if (e.target.checked){
            ...
            Object.keys(itemchecked).forEach(
             function(key){
   ...
   function handleFilteredContents(){
     const filteredArray=  contentTypes.filter(
       function(ele){
           return ele>5
       }
     )
    ...
    function importContent(data: string){
        ...
        filteredContentTypes.forEach(function(content:any){
            promiseArray.push(fetch(`https://api.contentful.com/spaces/${importSpaceId}/environments/${importEnvironment}/content_types`,
    ...
    function showModal() {
     ...
     setShown(true)
        setInterval(function () { Setpercent(percent + 60); }, 1000);
        setInterval(function () { Setpercent(  100); }, 3000);
        setTimeout(function () {
  ...
  function SubmitApiKey (val:string){
   ...
   function handleApikeySubmit(apikey:string){
    ...
    function handleToggledEnvironment(env:any){
        ...
        fetch(`https://api.contentful.com/spaces/za6nliv80lnb/environments/${env}/content_types`,
        {
            headers: {
                Authorization: ` Bearer ${apiKeyValue}`
            }
        ...
        function handleCheckedContentTypes(e:any,contentElemnt:any){
            ...
            if(e.target.checked){
                SetCheckedContentTypes({ ...checkedContentTypes,[e.target.name]:e.target.checked});
               let newarray=[]
                newarray.push(
                    {
                ...
                SetCheckedContentTypes({ ...checkedContentTypes, [e.target.name]: false })

                 let uncheckedvalues= filteredContentTypes.filter(
                   function(ele:any){
    ...
    return(
       <div>
                       ...
                       <div className="form">
                         ...
                         <div className="form-border">
                           <div className="form-import__wrapper">
                                <div>
                                    <Paragraph element="h1" > Management Token  to access where to import from </Paragraph>
                                </div>
                                <div className="">
                                         <div className="management__token">
                                            ...
                                            <div className="management__token__button">
                                                <Button onClick={() => handleApikeySubmit(apiKeyValue)}>Go</Button>
                            ...
                            <div>
                                <Paragraph element="h1" > Select spaces to import from   </Paragraph>
                            </div>
                                                ...
                                                spaces.map(function(space){
                                                   return(
                                                       <li className="checkbox_wrapper-list-item">
                                                           <Checkbox onClick={() => handleToggledSpace(space)} labelText="" name={space.name} id="checkbox" />
                            ...
                            <div>
                                <Paragraph element="h1" > Select Environments Types to import from  </Paragraph>
                            </div>
                            <div className="checkbox_wrapper">
                                <ul className="checkbox_wrapper-list">
                                            {
                                                environments.map(function (environment) {
                                                    return (
                                                        <li className="checkbox_wrapper-list-item">
                                                            <Checkbox checked={itemchecked[environment.name]} onClick={(e) => { checkedProperties(e) }} labelText="" name={environment.name} id="checkbox" />
                            ...
                            <div className="import-title">
                                <Paragraph element="h1" > Select Content to import    </Paragraph>
                            </div>
                            <div className="checkbox_wrapper">
                                <ul className="checkbox_wrapper-list">
                                            {
                                                contentTypes.map(function (content) {
                                                    return (
                                                        <li className="checkbox_wrapper-list-item">
                                                            <Checkbox checked={checkedContentTypes[content.name]} onClick={(e) => handleCheckedContentTypes(e, content)} labelText="" name={content.name} id="checkbox" />
                                                            <div className="checkbox_wrapper-list-item-paragraph">
                            ...
                            <div className="import_submit-wrapper ">
                                <div>
                                    <Paragraph element="p">Are you ready to import ? This cannot be undone </Paragraph>
                                </div>
                                <div>
            ...
            <React.Fragment>
                <Modal onClose={() => hideModal()} title="Centered modal" isShown={isShown}>
                    {() => (
                        <React.Fragment>
                        ...
                        <div className="modal-wrapper-importing">
                               ...
                               <div className="progressbar-wrapper">
                                    <Line className="progressbar" percent={`${percent}`}  strokeWidth="1" strokeColor="#2E75D4" />

                               </div>
                              
                                <div><Paragraph>Content Type 3/3</Paragraph></div>
                                <div><Paragraph>Content 1/10</Paragraph></div>
